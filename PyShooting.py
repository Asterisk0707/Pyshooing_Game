...
class Rock(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        rock_images = ('rock01.png', 'rock02.png', 'rock03.png', 'rock04.png', 'rock05.png', \
                       ...
                       'rock26.png', 'rock27.png', 'rock28.png', 'rock29.png', 'rock30.png')  # 이미지 불러오기
...
def game_loop():
    ...
    gameouver_sound = pygame.mixer.Sound("gameover.wav")
    pygame.mixer.music.load('music.wav')
    pygame.mixer.music.play(-1)
    fps_clock = pygame.time.Clock()
    
    gameOver_image = pygame.image.load('GAMEOVER.png')
    gameOver_image = pygame.transform.scale(gameOver_image,(480,480))
    ...
    while not done:
        ...
        if fighter.collide(rocks) or count_missed >= 3: # 돌에 부딪치면?
            pygame.mixer.music.stop()
            occur_explosion(screen, fighter.rect.x, fighter.rect.y)
            pygame.display.update()
            gameouver_sound.play()

            screen.blit(gameOver_image, background_image.get_rect())
            pygame.display.update()
            sleep(1)
